...
// ---------------------------------------------------------------------------
// POST — x402 payment flow + summarization
// ---------------------------------------------------------------------------

export async function POST(req: NextRequest) {
  // Parse body first so we can validate regardless of payment state
  ...
  // In a real deployment the middleware would verify the tx on-chain here.
  // For the demo we accept any non-empty value.
  ...
  // If no API key, return a mock summary so the demo always works
